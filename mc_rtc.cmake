...
if(PYTHON_BINDING)
  AddProject(
    ...
    origin/master
    CMAKE_ARGS
    -DPIP_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}
    APT_PACKAGES
    python-eigen
    python3-eigen
  )
...
AddProject(
  ...
  origin/master
  CMAKE_ARGS
  -DINSTALL_PDF_DOCUMENTATION:BOOL=OFF
  -DINSTALL_HTML_DOCUMENTATION:BOOL=OFF
  APT_PACKAGES
  liblexls-dev
)
...
if(WITH_ROS_SUPPORT)
  AddProject(
    gram_savitzky_golay
    GITHUB
    jrl-umi3218/gram_savitzky_golay
    GIT_TAG
    origin/master
    APT_PACKAGES
...
AddProject(
  ...
  CMAKE_ARGS
  ${MC_STATE_OBSERVATION_OPTIONS}
  DEPENDS
  ${MC_STATE_OBSERVATION_DEPENDS}
  APT_PACKAGES
