...
if(N_SKIPLIST EQUAL 0)
  set(CONFIG_SKIPLIST_COMMAND ${CONFIG_SKIPLIST_COMMAND} catkin config ${NO_SKIPLIST_OPTION})
  set(CONFIG_SKIPLIST_COMMAND_COMMENT "Clearing skiplist for ${WKS}")
else()
  set(CONFIG_SKIPLIST_COMMAND ${CONFIG_SKIPLIST_COMMAND} catkin config ${SKIPLIST_OPTION} ${SKIPLIST})
