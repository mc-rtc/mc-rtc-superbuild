...
if("${WORKSPACE_TYPE}" STREQUAL "make")
  ...
  if(EXISTS "${CATKIN_DIR}/.catkin_tools")
    message(FATAL_ERROR "It appears there's already a catkin build workspace in ${CATKIN_DIR}")
  endif()
else()
  ...
  if(EXISTS "${CATKIN_DIR}/src/CMakeLists.txt")
    message(FATAL_ERROR "It appears there's already a catkin_make workspace in ${CATKIN_DIR}")
  endif()
endif()
