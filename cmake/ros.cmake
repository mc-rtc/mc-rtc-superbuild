...
function(CreateCatkinWorkspace)
  ...
  if(DEFINED CMAKE_C_COMPILER_LAUNCHER)
    ...
    list(PREPEND CC_WORKSPACE_ARGS_CATKIN_BUILD_ARGS -DCMAKE_C_COMPILER_LAUNCHER="${CMAKE_C_COMPILER_LAUNCHER}")
  endif()
  if(DEFINED CMAKE_CXX_COMPILER_LAUNCHER)
    string(REPLACE ";" "$<SEMICOLON>" CMAKE_CXX_COMPILER_LAUNCHER "${CMAKE_CXX_COMPILER_LAUNCHER}")
    list(PREPEND CC_WORKSPACE_ARGS_CATKIN_BUILD_ARGS -DCMAKE_CXX_COMPILER_LAUNCHER="${CMAKE_CXX_COMPILER_LAUNCHER}")
  endif()
  if(DEFINED CMAKE_C_FLAGS AND NOT "${CMAKE_C_FLAGS}" STREQUAL "")
    string(REPLACE ";" "$<SEMICOLON>" CMAKE_C_FLAGS "${CMAKE_C_FLAGS}")
    list(PREPEND CC_WORKSPACE_ARGS_CATKIN_BUILD_ARGS -DCMAKE_C_FLAGS="${CMAKE_C_FLAGS}")
  endif()
  if(DEFINED CMAKE_CXX_FLAGS AND NOT "${CMAKE_CXX_FLAGS}" STREQUAL "")
    string(REPLACE ";" "$<SEMICOLON>" CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS}")
    list(PREPEND CC_WORKSPACE_ARGS_CATKIN_BUILD_ARGS -DCMAKE_CXX_FLAGS="${CMAKE_CXX_FLAGS}")
  endif()
