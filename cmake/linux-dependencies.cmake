...
if(WITH_ROS_SUPPORT AND ROS_DISTRO)
  if(DPKG)
    ...
    if(NOT EXISTS /etc/apt/sources.list.d/ros-latest.list)
      ...
      if(ROS_IS_ROS2)
        execute_process(COMMAND bash -c "sudo curl -sSL https://raw.githubusercontent.com/ros/rosdistro/master/ros.key -o /usr/share/keyrings/ros-archive-keyring.gpg")
      else()
      ...
      if(ROS_IS_ROS2)
        set(ROS_MIRROR "deb [arch=$(dpkg --print-architecture) signed-by=/usr/share/keyrings/ros-archive-keyring.gpg] http://packages.ros.org/ros2/ubuntu")
      else()
        set(ROS_MIRROR "deb http://packages.ros.org/ros/ubuntu")
      endif()
      execute_process(COMMAND sudo bash -c "echo \"${ROS_MIRROR} ${DISTRO} main\" > /etc/apt/sources.list.d/ros-latest.list" RESULT_VARIABLE BASH_FAILED)
      if(BASH_FAILED)
