function(GetCommandPrefix VAR)
  ...
  if(WITH_ROS_SUPPORT)
    list(APPEND ${VAR} ROS_PACKAGE_PATH=$ENV{ROS_PACKAGE_PATH} ROS_DISTRO=$ENV{ROS_DISTRO} PYTHONPATH=$ENV{PYTHONPATH} ROS_ROOT=$ENV{ROS_ROOT} ROS_ETC_DIR=$ENV{ROS_ETC_DIR} ROS_PARALLEL_JOBS=$ENV{ROS_PARALLEL_JOBS})
  endif()
  if(EMSCRIPTEN)
