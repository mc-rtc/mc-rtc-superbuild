...
if(INSTALL_SYSTEM_DEPENDENCIES)
  ...
  if(PYTHON_BINDING)
    if(PYTHON_BINDING_BUILD_PYTHON2_AND_PYTHON3)
      execute_process(COMMAND sudo pip2 install ${PIP_DEPENDENCIES})
      execute_process(COMMAND sudo pip3 install ${PIP_DEPENDENCIES})
    elseif(PYTHON_BINDING_FORCE_PYTHON2)
      execute_process(COMMAND sudo pip2 install ${PIP_DEPENDENCIES})
    elseif(PYTHON_BINDING_FORCE_PYTHON3)
      execute_process(COMMAND sudo pip3 install ${PIP_DEPENDENCIES})
    else()
      execute_process(COMMAND sudo pip install ${PIP_DEPENDENCIES})
    endif()
  endif()
endif()
