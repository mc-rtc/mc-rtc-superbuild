function(GetExtraPythonPath OUT_VAR)
  ...
  # https://github.com/mesonbuild/meson/issues/8739 for an overview of the problem
  if(EXISTS /etc/debian_version)
    ...
    string(REPLACE "python3/" "${PYTHON_VERSION}/" PYTHON_INSTALL_DESTINATION
...
if(NOT "$ENV{PYTHONPATH}" MATCHES "${EXTRA_PYTHONPATH}")
  if(WIN32)
    if("$ENV{PYTHONPATH}" STREQUAL "")
      set(ENV{PYTHONPATH} "${EXTRA_PYTHONPATH}")
    else()
    ...
    if(MC_RTC_SUPERBUILD_SET_ENVIRONMENT)
      execute_process(
        COMMAND
          powershell -c
          "[System.Environment]::SetEnvironmentVariable('PYTHONPATH', '${DIR};' + [System.Environment]::GetEnvironmentVariable('PYTHONPATH', 'User'), 'User')"
          COMMAND_ERROR_IS_FATAL ANY
      )
      if(DEFINED ENV{GITHUB_ENV})
...
if(NOT "$ENV{PKG_CONFIG_PATH}" MATCHES "${CMAKE_INSTALL_PREFIX}/lib/pkgconfig")
  if(WIN32)
    set(PKG_CONFIG_PATH_SEP ";")
  else()
    set(PKG_CONFIG_PATH_SEP ":")
  endif()
  set(ENV{PKG_CONFIG_PATH}
      "${CMAKE_INSTALL_PREFIX}/lib/pkgconfig${PKG_CONFIG_PATH_SEP}$ENV{PKG_CONFIG_PATH}"
  )
endif()
