function(add_to_path DIR)
  ...
  if(WIN32)
    ...
    if(MC_RTC_SUPERBUILD_SET_ENVIRONMENT)
      execute_process(COMMAND powershell -c "[System.Environment]::SetEnvironmentVariable('PATH', '${DIR};' + [System.Environment]::GetEnvironmentVaraible('PATH', 'User'), 'User')" COMMAND_ERROR_IS_FATAL ANY)
    endif()
  else()
    set(ENV{PATH} "${DIR}:$ENV{PATH}")
  endif()
