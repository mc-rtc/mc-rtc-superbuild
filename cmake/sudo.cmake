...
function(PrefixRequireSudo PREFIX VAR_OUT)
  if(NOT EXISTS "${PREFIX}")
    execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory ${PREFIX} OUTPUT_QUIET ERROR_QUIET)
  endif()
  ...
  if(NOT EXISTS ${TEST_FILE})
    ...
    if(NOT SUDO_CMD)
      message(FATAL_ERROR "sudo is not installed on this system and the install prefix (${PREFIX}) is not writable by the current user.
