...
You have local changes in ${SOURCE_DIR} that would be overwritten by this change. Save your work before continuing")
  ...
  if(DEFINED CMAKE_C_COMPILER_LAUNCHER)
    ...
    list(PREPEND CMAKE_ARGS -DCMAKE_C_COMPILER_LAUNCHER="${CMAKE_C_COMPILER_LAUNCHER}")
  endif()
  if(DEFINED CMAKE_CXX_COMPILER_LAUNCHER)
    string(REPLACE ";" "$<SEMICOLON>" CMAKE_CXX_COMPILER_LAUNCHER "${CMAKE_CXX_COMPILER_LAUNCHER}")
    list(PREPEND CMAKE_ARGS -DCMAKE_CXX_COMPILER_LAUNCHER="${CMAKE_CXX_COMPILER_LAUNCHER}")
  endif()
