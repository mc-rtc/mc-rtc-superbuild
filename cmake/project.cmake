...
function(AddProject NAME)
  ...
  if(ADD_PROJECT_ARGS_GET_SOURCE_IN_SOURCE)
    set(SOURCE_DIR "${PROJECT_SOURCE_DIR}/src/${NAME}")
  else()
    if(ADD_PROJECT_ARGS_SOURCE_DIR)
      set(SOURCE_DIR "${ADD_PROJECT_ARGS_SOURCE_DIR}")
    else()
      set(SOURCE_DIR "${PROJECT_BINARY_DIR}/src/${NAME}")
    endif()
  endif()
  set(BINARY_DIR "${PROJECT_BINARY_DIR}/build/${NAME}")
  if(WIN32)
    set(ENV_PATH "${EXTRA_PATH};$(PATH)")
    string(REPLACE ";" "$<SEMICOLON>" ENV_PATH "${ENV_PATH}")
  else()
    set(ENV_PATH "$ENV{PATH}")
  endif()
  set(COMMAND_PREFIX ${CMAKE_COMMAND} -E env PATH=${ENV_PATH} CMAKE_PREFIX_PATH=$ENV{CMAKE_PREFIX_PATH} PKG_CONFIG_PATH=$ENV{PKG_CONFIG_PATH})
  if(APPLE)
