...
set(WITH_ROS_SUPPORT OFF CACHE BOOL "" FORCE)
set(INSTALL_DOCUMENTATION OFF CACHE BOOL "" FORCE)
set(BUILD_BENCHMARKS OFF CACHE BOOL "" FORCE)
set(PYTHON_BINDING OFF CACHE BOOL "" FORCE)
set(INSTALL_SYSTEM_DEPENDENCIES OFF CACHE BOOL "" FORCE)
...
AddProject(libf2c-emscripten
  GITHUB gergondet/libf2c-emscripten
  CONFIGURE_COMMAND ""
  BUILD_COMMAND ${CMAKE_COMMAND} -E chdir <SOURCE_DIR> emmake make -j${NCPU}
  INSTALL_COMMAND ${CMAKE_COMMAND} -E chdir <SOURCE_DIR> emmake make install
)
...
file(COPY cmake/emscripten/emscripten.jam DESTINATION "${BOOST_SOURCE_DIR}/tools/build/src/tools/")

set(b2_command ${CMAKE_COMMAND} -E chdir <SOURCE_DIR> emconfigure ./b2
  toolset=emscripten
  --with-filesystem
...
AddProject(spdlog
  ...
  GIT_TAG v1.6.1
  CMAKE_ARGS -DSPDLOG_BUILD_TESTS=OFF -DSPDLOG_BUILD_EXAMPLE:BOOL=OFF -DSPDLOG_BUILD_SHARED:BOOL=OFF
  SKIP_TEST
)
