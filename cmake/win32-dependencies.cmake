...
if(NOT DEFINED ENV{BOOST_ROOT} OR NOT EXISTS "$ENV{BOOST_ROOT}")
  ...
  if(${MSVC_TOOLSET_VERSION} EQUAL 141) # VS 2017
    ...
    set(BOOST_BINARIES_SHA256 2c17e5fe2b60009395e69c8ba4859fc891bf250d0af5b3e414215cfba3f69213)
  elseif(${MSVC_TOOLSET_VERSION} EQUAL 142) # VS 2019
    set(MSVC_TOOLSET_VERSION_DOT "14.2")
    set(BOOST_BINARIES_SHA256 898a6b2df4edb842a4484a324849798952aa0ff2ca69fbf1fbf4cc0570b5d45e)
  elseif(${MSVC_TOOLSET_VERSION} EQUAL 143) # VS 2022
    set(MSVC_TOOLSET_VERSION_DOT "14.3")
    set(BOOST_BINARIES_SHA256 492b4fbeb08c2e18b3825520e7381c219abe055a33993a23b0376f9f1365f94f)
  else()
  ...
  if(NOT EXISTS "${BOOST_ROOT}")
    set(BOOST_BINARIES "https://boostorg.jfrog.io/artifactory/main/release/${BOOST_VERSION}/binaries/boost_${BOOST_VERSION_}-msvc-${MSVC_TOOLSET_VERSION_DOT}-64.exe")
